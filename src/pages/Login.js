...
export default function Login() {
  ...
  return (
    <Grid container direction="row" spacing={0} className={classes.root} >
      ...
      >
        <Card style={{ padding: "35px 29px", height: "441px", width: "472px" }}>
          <Typography className={classes.text20}>Welcome to Smart Garden</Typography>

          <form>
            <label className={classes.label}>Username</label>
            <br></br>
            <input type="text" className={classes.input} name="username" placeholder = "Username" 
            // onChange={onChange}
            ></input>
            ...
            <br></br>
            <input type="password" className={classes.input} name="password" placeholder ="Password" 
            // onChange={onChange}
            ></input>
