...
if (!window.localStorage.getItem(localStorage.getItem("username")) {
    window.localStorage.setItem(localStorage.getItem("username"), JSON.stringify([
...
const initialState = JSON.parse(window.localStorage.getItem(localStorage.getItem("username")))
  ...
  reducers: {
    increment: (state, action) => {
      ...
      if (existingItem) {
          ...
          window.localStorage.setItem(localStorage.getItem("username"), JSON.stringify(state))
      }
    },
    ...
    removeItem: (state, action) => {
      ...
      if (existingItem) {
        ...
        window.localStorage.setItem(localStorage.getItem("username"), JSON.stringify(newState))
        return newState
      }
    },
    addItem: {
